/**
 * @extracted-from
 *   A: Driverse_FE_Autocredit @ b96eda3 src/components/upload/upload-avatar.tsx
 *   B: Driverse_FE_Business   @ b96eda3 src/components/upload/upload-avatar.tsx
 * @status identical
 * @notes Byte-identical in both apps; lifted verbatim. themeVars/fBytes/icon imports repointed; React types imported explicitly.
 */
