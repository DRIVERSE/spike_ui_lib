/**
 * @extracted-from
 *   A: Driverse_FE_Autocredit @ b96eda3 src/components/upload/upload-illustration.tsx
 *   B: Driverse_FE_Business   @ b96eda3 src/components/upload/upload-illustration.tsx
 * @status identical
 * @notes Byte-identical in both apps; 404 lines of inline SVG, lifted verbatim. Only the useTheme
 *        import path changed — it reads themeVars, whose shape is unchanged by the W2 decoupling.
 */
