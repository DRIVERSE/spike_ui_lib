/**
 * @extracted-from
 *   A: Driverse_FE_Autocredit @ b96eda3 src/components/animate/variants/transition.ts
 *   B: Driverse_FE_Business   @ b96eda3 src/components/animate/variants/transition.ts
 * @status identical
