/**
 * @extracted-from
 *   A: Driverse_FE_Autocredit @ b96eda3 src/components/editor/styles.ts
 *   B: Driverse_FE_Business   @ b96eda3 src/components/editor/styles.ts
 * @status adopted-A
 * @notes Differs from B by one stray leading space on the `font-family: 'Outfit'` line; A adopted.
 *        Only the themeVars import path changed.
 */
