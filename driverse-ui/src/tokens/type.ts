/**
 * @extracted-from
 *   A: Driverse_FE_Autocredit @ b96eda3 src/theme/type.ts
 *   B: Driverse_FE_Business   @ b96eda3 src/theme/type.ts
 * @status identical
 * @notes Byte-identical in both apps. Two edits: #/enum -> ./enum for ThemeMode, and React types are
 *        imported explicitly instead of relying on the apps' ambient global React namespace.
 */
