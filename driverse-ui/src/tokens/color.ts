/**
 * @extracted-from
 *   A: Driverse_FE_Autocredit @ b96eda3 src/theme/tokens/color.ts
 *   B: Driverse_FE_Business   @ b96eda3 src/theme/tokens/color.ts
 * @status identical
 * @notes Byte-identical in both apps. Imports rewritten: @/utils/theme -> ./css-var-utils, #/enum -> ./enum.
 */

import { rgbAlpha } from "./css-var-utils";
