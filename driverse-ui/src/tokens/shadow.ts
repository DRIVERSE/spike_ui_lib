/**
 * @extracted-from
 *   A: Driverse_FE_Autocredit @ b96eda3 src/theme/tokens/shadow.ts
 *   B: Driverse_FE_Business   @ b96eda3 src/theme/tokens/shadow.ts
 * @status identical
 * @notes Byte-identical in both apps; lifted verbatim. Keeps the `color` runtime dependency.
 */
